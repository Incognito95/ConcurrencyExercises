package Uge1.ConcurrencyExercisesDay2.Exercise5.simpledemo;
...
public class Deadlock {
    public static void main(String[] args) throws InterruptedException {
        ...
        t1.start();
        t2.start();
        new Thread(new DeadlockDetector()).start(); //You could execute the DeadlockDetector from this thread
        t1.join();
        t2.join();
